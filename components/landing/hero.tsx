...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen flex flex-col bg-gradient-to-b from-white to-neutral-50/30">
        ...
        <div className="mx-auto max-w-5xl text-center flex-1 flex flex-col justify-center">
          ...
          >
            <h1 className="text-5xl font-bold tracking-tight text-neutral-900 sm:text-6xl lg:text-7xl xl:text-8xl leading-[1.1]">
              Accounting that{" "}
              <span className="bg-gradient-to-r from-[#D4AF37] via-[#DAB743] to-[#C39F2F] bg-clip-text text-transparent">
                runs itself
              </span>
            </h1>
          </motion.div>
          ...
          >
            Autonomous reconciliation, AI categorization, and global compliance for modern businesses.
            Let OpportunityOS handle <span className="font-semibold text-neutral-700">85% of your bookkeeping</span> with{" "}
          ...
          >
            <a
              href="/signup"
              className="group relative inline-flex items-center justify-center px-8 py-3.5 text-base font-semibold text-black bg-gradient-to-r from-[#D4AF37] to-[#C39F2F] rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 w-full sm:w-auto"
            >
              Start free trial
            ...
            >
              <svg className="mr-2 w-4 h-4 text-neutral-500" fill="currentColor" viewBox="0 0 20 20">
