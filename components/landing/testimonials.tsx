...
const testimonials = [
  {
    ...
    body: 'I manage 12 clients and Accunza saves me 10 hours per client every month. Reconciliation is finally reliable.',
  ...
  },
  {
    ...
    body: 'I scan receipts from my phone and Accunza categorizes everything. I finally understand my cash flow.',
  ...
  },
  {
    ...
    body: 'I invoice in 3 currencies and Accunza handles conversions and revaluation. Monthly close is finally predictable.',
...
const TestimonialCard = ({
  ...
  return (
    <div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-gray-200 bg-white p-10 shadow-lg hover:shadow-xl transition-all duration-300">
      <div className="absolute -top-5 -left-5 -z-10 h-40 w-40 rounded-full bg-linear-to-b from-[#D4AF37]/10 to-transparent blur-md"></div>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              <div className="absolute inset-x-0 -top-px mx-auto h-0.5 w-1/2 bg-linear-to-r from-transparent via-[#D4AF37] to-transparent shadow-2xl transition-all duration-500 group-hover:w-3/4"></div>
              <div className="absolute inset-x-0 -bottom-px mx-auto h-0.5 w-1/2 bg-linear-to-r from-transparent via-[#D4AF37] to-transparent shadow-2xl transition-all duration-500 group-hover:h-px"></div>
              <span className="relative text-gray-700">Testimonials</span>
            </button>
          </div>
          <h2 className="mt-5 bg-linear-to-r from-gray-600 via-gray-900 to-gray-600 bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px] relative z-10">
            Trusted by accountants and founders
          </h2>

          <p className="mt-5 relative z-10 text-center text-lg text-gray-600">
            From solo freelancers to multi-client accounting firms, Accunza automates the work that
            slows you down.
          </p>
        </div>
