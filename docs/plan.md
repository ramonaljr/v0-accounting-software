...
- **W4–5:** Bank feeds (Plaid/Wise), ingestion queues, reconciliation baseline, reports v1.
- **W6–7:** AI Co-Pilot (intent → action), LedgerBot v1 (categorization), ReconAI v1 (one-click).
